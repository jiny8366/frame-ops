...
with c1:
    st.markdown("**마스터/권한**")
    st.page_link("pages/90_admin_portal.py", label="홈 · 지점 등록", icon="🏠")
    st.page_link("pages/01_상품등록.py", label="상품 등록", icon="📦")
    st.page_link("pages/17_매입처관리.py", label="매입처 관리", icon="🏷️")
    st.page_link("pages/14_본사·스태프·권한.py", label="본사·스태프·권한", icon="🧑‍💼")
    st.page_link("pages/15_지점·매니저·판매사.py", label="지점·매니저·판매사", icon="👤")
with c2:
    st.markdown("**전표/재고**")
...
with c3:
    ...
    st.page_link("pages/13_매입처리.py", label="매입처리", icon="🧾")
    ...
    st.page_link("pages/12_판매데이터가져오기.py", label="판매 데이터 가져오기", icon="📑")
